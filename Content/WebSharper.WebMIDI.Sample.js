...
{
 "use strict";
 var WebSharper,WebMIDI,Sample,Client,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,TemplateHole,Var,Handler,Unchecked,WebSharper$WebMIDI$Sample_Templates,ConcreteVar,Snap,TemplateHoleModule,Text,TextView,SC$1,System,Guid,EventQ,JavaScript,Pervasives,Concurrency,Promise,EventTarget,WindowOrWorkerGlobalScope,JS,Collections,FSharpMap,Client$1,Templates,Doc,Abbrev,Fresh,Dictionary,Node,Object,AsyncBody,Event,CT,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,Scheduler,Error,NonStandardPromiseRejectionException,SC$2,DictionaryUtil,Enumerator,T,SC$3,Docs,SC$4,DocElemNode,CharacterData,OperationCanceledException,Pair,CancellationTokenSource,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Attribute,Event$1,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$5,BalancedTree,HashSetUtil,SC$6,SC$7,AppendList,DynamicAttrNode,KeyNotFoundException,SC$8,Easing,HashSet$1,BindVar,String,CheckedInput,DomNodes,Char,DateUtil,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,Promise$1,console,Runtime$1,Math,Date;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 WebMIDI=WebSharper.WebMIDI=WebSharper.WebMIDI||{};
 Sample=WebMIDI.Sample=WebMIDI.Sample||{};
 ...
 WebSharper$WebMIDI$Sample_Templates=Global.WebSharper$WebMIDI$Sample_Templates=Global.WebSharper$WebMIDI$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_WebMIDI_Sample$Client=Global.StartupCode$WebSharper_WebMIDI_Sample$Client||{};
 ...
 Elt$1=TemplateHoleModule.Elt=TemplateHoleModule.Elt||{};
 Attribute=TemplateHoleModule.Attribute=TemplateHoleModule.Attribute||{};
 Event$1=TemplateHoleModule.Event=TemplateHoleModule.Event||{};
 ...
 {
  var _,b,_this,_this$1,t,p,i;
  Var$1.Create$1("");
  _=(b=(_this=(_this$1=(t=new ProviderBuilder.New$1(),(t.h.push(Handler.EventQ2(t.k,"connectmidi",function()
  {
   return t.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.connectMIDI()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(_this$1.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this$1)),(_this.h.push(new TextView.New("midimessages",Client.midiMessages().get_View())),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$WebMIDI$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",_);
 };
 Client.midiMessages=function()
 {
  SC$1.$cctor();
  return SC$1.midiMessages;
 };
 Client.statusMessage=function()
 {
  SC$1.$cctor();
  return SC$1.statusMessage;
 };
 Client.connectMIDI=function()
 {
  var _;
  function f()
  {
   function f$1()
   {
    return self.navigator.requestMIDIAccess().then(function(a)
    {
     Client.statusMessage().Set("MIDI Access Granted!");
     a.inputs.forEach(function(input)
     {
      return input.addEventListener("midimessage",Client.handleMIDIMessage);
     });
   ...
   {
    var $1;
    Client.statusMessage().Set("MIDI Access Denied!");
    $1=a.message;
    (function($2)
    {
     return $2("MIDI Connection Error: "+Global.String($1));
    }(function(s)
    {
     console.log(s);
    }));
   ...
   {
    return f$2(Promise.unwrapExn(d));
   });
  }
  _=null;
  return new Promise$1(function($1)
 ...
 Client.handleMIDIMessage=function(event)
 {
  var data;
  data=event.data;
  (function($1)
  {
   return $1("MIDI Message: "+Global.String(data));
  }(function(s)
  {
   console.log(s);
  }));
  Client.midiMessages().Set(Global.String(Client.midiMessages())+"\n"+Global.String(data));
 };
 ...
 WebSharper$WebMIDI$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.statusMessage=Var$1.Create$1("Waiting for MIDI connection...");
  SC$1.midiMessages=Var$1.Create$1("");
 };
 ...
 Templates.InlineTemplate=function(el,fillWith)
 {
  ...
  function tryGetAsDoc(name)
  {
   ...
   return m[0]?(th=m[1],th instanceof Elt$1?{
    $:1,
    $0:th.get_Value()
   }:th instanceof Text?{
    $:1,
  ...
  Templates.foreachNotPreserved(el,"[ws-on]",function(e$1)
  {
   addAttr(e$1,AttrProxy.Concat(Arrays.choose(function(x$1)
   {
    ...
    return m[0]?(th=m[1],th instanceof Event$1?{
     $:1,
 ...
 Elt$1=TemplateHoleModule.Elt=Runtime$1.Class({
  get_Value:function()
  {
   return this.fillWith;
  },
 ...
 Event$1=TemplateHoleModule.Event=Runtime$1.Class({
  get_Value:function()
  {
   return this.fillWith;
  },
 ...
 SC$8.$cctor=function()
 {
  ...
  SC$8.DateTimeSetUnchecked=function(el)
  {
   return function(i)
   {
  ...
  SC$8.DateTimeGetUnchecked=function(el)
  {
   var s$7,m,o,m$1;
   s$7=el.value;
  ...
  SC$8.DateTimeApplyUnchecked=(g$1=BindVar.DateTimeGetUnchecked(),(s$1=BindVar.DateTimeSetUnchecked(),function(v)
  {
   return BindVar.ApplyValue(g$1,s$1,v);
  }));
  SC$8.FileSetUnchecked=function()
  {
   return function()
   {
    return null;
  ...
  SC$8.FileGetUnchecked=function(el)
  {
   var files;
   files=el.files;
   return{
  ...
  SC$8.FileApplyUnchecked=(g$2=BindVar.FileGetUnchecked(),(s$2=BindVar.FileSetUnchecked(),function(v)
  {
  ...
  SC$8.IntApplyUnchecked=(g$3=BindVar.IntGetUnchecked(),(s$3=BindVar.IntSetUnchecked(),function(v)
  {
  ...
  SC$8.IntApplyChecked=(g$4=BindVar.IntGetChecked(),(s$4=BindVar.IntSetChecked(),function(v)
  {
  ...
  SC$8.FloatApplyUnchecked=(g$5=BindVar.FloatGetUnchecked(),(s$5=BindVar.FloatSetUnchecked(),function(v)
  {
  ...
  SC$8.FloatApplyChecked=(g$6=BindVar.FloatGetChecked(),(s$6=BindVar.FloatSetChecked(),function(v)
  {
 ...
 {
  SC$8.$cctor();
  return SC$8.DateTimeSetUnchecked;
 };
 BindVar.DateTimeGetUnchecked=function()
 {
  SC$8.$cctor();
  return SC$8.DateTimeGetUnchecked;
 };
 ...
 {
  SC$8.$cctor();
  return SC$8.FileSetUnchecked;
 };
 BindVar.FileGetUnchecked=function()
 {
  SC$8.$cctor();
  return SC$8.FileGetUnchecked;
 };
 ...
 {
  SC$8.$cctor();
  return SC$8.DateTimeApplyUnchecked;
 };
 BindVar.FileApplyUnchecked=function()
 {
  SC$8.$cctor();
  return SC$8.FileApplyUnchecked;
 };
